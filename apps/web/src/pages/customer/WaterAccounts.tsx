...
import { WaterAccount360 } from './WaterAccount360';
...
export default function WaterAccounts() {
  ...
  // ---- E8 360° 抽屉 ----
  const [drawer360Id, setDrawer360Id] = useState<string | null>(null);
            ...
            render: (_: unknown, record: WaterAccount) => {
              ...
              return (
                <Space size={4} wrap>
                  ...
                  <Button
                    size="small"
                    onClick={() => setDrawer360Id(record.id)}
                  >
                    360°
                  </Button>
                  <Button
  ...
  return (
    ...
    >
      ...
      {/* E8 360° 抽屉：概览/水表/抄表/结算/账单/缴费/预存/事件，权限域独立加载 */}
      <WaterAccount360
        accountId={drawer360Id}
        onClose={() => setDrawer360Id(null)}
        onOpenMeterOps={(id) => {
          setDrawer360Id(null);
          setMeterDrawerId(id);
          setMeterDetail(null);
          setMeterModal(null);
          void loadMeterDetail(id);
        }}
      />
