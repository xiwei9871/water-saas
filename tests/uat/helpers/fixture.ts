...
if (!['water_uat_v011', 'water_pilot_fix_uat_v012', 'water_recovery_uat_20260920', 'water_uat_v02', 'water_uat_e5', 'water_uat_e6', 'water_uat_e7'].includes(databaseName)) throw new Error('Refusing non-UAT database');
